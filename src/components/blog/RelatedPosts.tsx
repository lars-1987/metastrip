...
export default function RelatedPosts({ currentId }: { currentId: string }) {
  ...
  return (
    <div className="mt-16">
      <h3 className="text-xl font-bold text-white/95 font-[family-name:var(--font-outfit)] tracking-[-0.02em] mb-5">
        Keep reading
      </h3>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {related.map((article) => (
          ...
          >
            <div className="mb-2.5"><Icon name={article.coverIcon} size={28} weight="duotone" className="text-white/90" /></div>
            ...
            <h4 className="text-[15px] font-semibold text-white/90 font-[family-name:var(--font-outfit)] leading-[1.35] tracking-[-0.01em] mt-2.5">
              {article.title}
            </h4>
            <span className="block mt-2 text-[11px] text-white/30 font-[family-name:var(--font-mono)]">
