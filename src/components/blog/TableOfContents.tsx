...
export default function TableOfContents({
  ...
  return (
    <div className="sticky top-[100px] py-5">
      <div className="text-[10px] font-semibold text-white/25 font-[family-name:var(--font-mono)] tracking-[0.1em] uppercase mb-3.5">
        On this page
      </div>
        ...
        {sections.map((section, i) => (
          <button
            ...
            className={`text-left px-3 py-1.5 rounded-lg border-l-2 transition-all duration-200 cursor-pointer ${
              activeSection === i
                ? "border-l-purple-light text-white/80"
                : "border-l-white/[0.05] text-white/30 hover:bg-white/[0.02]"
            }`}
